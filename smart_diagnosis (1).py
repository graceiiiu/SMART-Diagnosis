...
model.save('smart_diagnosis_model.keras')

# Download it (look in Colab's file browser on the left)
...
"""Now, we need to connect it to the app. We just directly used GitHub and Streamlit."""